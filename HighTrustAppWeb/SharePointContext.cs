...
namespace HighTrustAppWeb
{
    ...
    public abstract class SharePointContextProvider
    {
        ...
        public static RedirectionStatus CheckRedirectionStatus(HttpContextBase httpContext, out Uri redirectUrl)
        {
            ...
            Uri spHostUrl = new Uri(WebConfigurationManager.AppSettings["SpHostUrl"]); 
        ...
        public SharePointContext CreateSharePointContext(HttpRequestBase httpRequest)
        {
            ...
            // SPLanguage
            string spLanguage = WebConfigurationManager.AppSettings["SpLanguage"]; 
            if (string.IsNullOrEmpty(spLanguage))
            {
                return null;
            }
            ...
            // SPClientTag
            string spClientTag = WebConfigurationManager.AppSettings["SpClientTag"]; 
            if (string.IsNullOrEmpty(spClientTag))
            {
                return null;
            }
            ...
            // SPProductNumber
            string spProductNumber = WebConfigurationManager.AppSettings["SpProductNumber"]; 
            if (string.IsNullOrEmpty(spProductNumber))
            {
                return null;
            }
